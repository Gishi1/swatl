...
Repository initialized 2026-09-16. Translation core (Phase 1) through Web GUI redesign + Context DB (Phase 7) complete. 401 tests passing (incl. 9 browser e2e), ruff clean; CI green on Python 3.11 and 3.12. Context-aware embedding retrieval (Ollama/sentence-transformers + FAISS) wired into translation, and a full-featured web GUI with multi-panel layout.
